/* Shared translations — Tennis With Ruben */
...
window.TWR_I18N = {
  pt: {
    ...
    "s2.label": "Contacto",
    "s2.title": "WhatsApp",
    "s2.desc": "Envia-me mensagem para esclarecer dúvidas ou combinar horários.",
    "s2.btn": "Contactar por WhatsApp",

    "s3.label": "Reservar",
    "s3.title": "Marcar Aula",
    "s3.desc": "Seleciona o horário pretendido e confirma a sessão comigo.",
    "s3.btn": "Reservar Aula",

    "s4.label": "Pagamento",
    "s4.title": "Pagar Online",
    "s4.desc": "Pagamento seguro por cartão através da Stripe. Indica o valor acordado comigo na página de pagamento.",
    "s4.btn": "Pagar com Cartão",

    "s5.label": "Sobre",
    "s5.title": "Sobre mim",
    "s5.desc": "Sou o Ruben, treinador de ténis na região de Albufeira. Dou aulas a adultos, crianças e adolescentes, desde iniciantes até jogadores em competição. Nas sessões trabalho contigo a técnica, a táctica e a confiança em court, de acordo com o teu nível e objectivos. Falo português e inglês fluentemente, e francês a um nível básico.",
    ...
    _book: "Bom dia Ruben, gostaria de marcar uma aula de ténis.",
    _contact: "Bom dia Ruben, gostaria de mais informação.",
  },
  ...
  en: {
    ...
    "s2.label": "Contact",
    "s2.title": "WhatsApp",
    "s2.desc": "Message me to ask questions or arrange lesson times.",
    "s2.btn": "Contact via WhatsApp",

    "s3.label": "Book",
    "s3.title": "Book a Lesson",
    "s3.desc": "Select your preferred time and confirm your session with me.",
    "s3.btn": "Book a Lesson",

    "s4.label": "Payment",
    "s4.title": "Pay Online",
    "s4.desc": "Secure card payment through Stripe. Enter the amount we agreed on the payment page.",
    "s4.btn": "Pay by Card",

    "s5.label": "About",
    "s5.title": "About me",
    "s5.desc": "I am Ruben, a tennis coach based in the Albufeira area. I teach adults, children, and teenagers, from beginners to competition players. In each session I work with you on technique, tactics, and confidence on court, aligned with your level and goals. I am fluent in Portuguese and English, with basic French.",
    ...
    _book: "Hello Ruben, I would like to book a tennis lesson.",
    _contact: "Hello Ruben, I would like more information.",
  },
  ...
  fr: {
    ...
    "s2.label": "Contact",
    "s2.title": "WhatsApp",
    "s2.desc": "Écrivez moi pour toute question ou pour convenir d'un horaire.",
    "s2.btn": "Contacter par WhatsApp",

    "s3.label": "Réserver",
    "s3.title": "Réserver un Cours",
    "s3.desc": "Choisissez l'horaire souhaité et confirmez la séance avec moi.",
    "s3.btn": "Réserver un Cours",

    "s4.label": "Paiement",
    "s4.title": "Payer en Ligne",
    "s4.desc": "Paiement sécurisé par carte via Stripe. Indiquez le montant convenu sur la page de paiement.",
    "s4.btn": "Payer par Carte",

    "s5.label": "À propos",
    "s5.title": "À propos de moi",
    "s5.desc": "Je suis Ruben, coach de tennis dans la région d'Albufeira. J'enseigne aux adultes, aux enfants et aux adolescents, des débutants aux joueurs en compétition. Lors de chaque séance, je travaille avec vous la technique, la tactique et la confiance sur le court, selon votre niveau et vos objectifs. Je parle couramment le portugais et l'anglais, et le français à un niveau de base.",
    ...
    _book: "Bonjour Ruben, je souhaiterais réserver un cours de tennis.",
    _contact: "Bonjour Ruben, je souhaiterais plus d'informations.",
  },
};
