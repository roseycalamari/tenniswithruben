...
window.TWR_I18N = {
  pt: {
    ...
    "duration.adults": "60 min",
    "duration.group": "60 min",
    "duration.60": "60 min",
    "duration.90": "1h30",
    ...
    "price.cancel.individual.body": "Se cancelares com menos de 24 horas de antecedência, aplica-se uma taxa de 50% sobre o valor da aula.",
    ...
    "price.cancel.group.refund": "Se um jogador cancelar com menos de 24 horas de antecedência, aplica-se uma taxa de 50% sobre o valor da aula.",
  ...
  en: {
    ...
    "duration.adults": "60 mins",
    "duration.group": "60 mins",
    "duration.60": "60 mins",
    "duration.90": "1h30",
    ...
    "price.cancel.individual.body": "If you cancel with less than 24 hours notice, a 50% fee applies to the lesson amount.",
    ...
    "price.cancel.group.refund": "If a player cancels with less than 24 hours notice, a 50% fee applies to the lesson amount.",
  ...
  fr: {
    ...
    "price.cancel.individual.body": "En cas d'annulation avec moins de 24 h de préavis, des frais de 50% s'appliquent sur le montant de la séance.",
    ...
    "price.cancel.group.refund": "Si un joueur annule avec moins de 24 h de préavis, des frais de 50% s'appliquent sur le montant de la séance.",
